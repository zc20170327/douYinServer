...
//    }
     ...
     * @return
     */
    public static RcsResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, RcsResult.class);
            }
     ...
     * @return
     */
    public static RcsResult format(String json) {
        try {
            return MAPPER.readValue(json, RcsResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static RcsResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
